        ...
        <div class="container sm-px-0 pt-2">
            <form class="" id="search-form" action="" method="GET">
                <div class="row">
                    ...
                    <div class="col-xl-9">
                        <!-- Category Banner -->
                        <div class="col-lg col-10" style="padding-left: initial;">
                            @if (isset($category_id))
                                @php
                                    $img = \App\Models\Category::find($category_id)->cover_photo;
                                @endphp
                                @if (isset($img))
                                    <img class="img-fluid" src="{{ uploaded_asset($img) }}" />
                                @endif
                            @endif
                        </div>
                        <br>
                        <!-- Breadcrumb -->
                        <div class="col-lg col-10" style="padding-left: initial;">
                            @include('frontend.inc.breabcrumb')
                        </div>
                        <!-- Top Filters -->
                        <div class="text-left">
