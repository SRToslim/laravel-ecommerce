<div class="text-left">
    ...
    <ul class="breadcrumb bg-transparent py-0 px-1">
        ...
        @if($detailedProduct->category->parentCategory->parentCategory != null)
        <li class="text-dark fw-600 breadcrumb-item opacity-50">
            <a class="text-reset" href="{{ route('products.category', \App\Models\Category::find($detailedProduct->category_id)->parentCategory->parentCategory->slug) }}">{{ \App\Models\Category::find($detailedProduct->category_id)->parentCategory->parentCategory->getTranslation('name') }}</a>
        </li>
        @endif
        <li class="text-dark fw-600 breadcrumb-item opacity-50">
            <a class="text-reset" href="{{ route('products.category', \App\Models\Category::find($detailedProduct->category_id)->parentCategory->slug) }}">{{ \App\Models\Category::find($detailedProduct->category_id)->parentCategory->getTranslation('name') }}</a>
        </li>
        @endif
        <li class="text-dark fw-600 breadcrumb-item opacity-50">
            <a class="text-reset" href="{{ route('products.category', \App\Models\Category::find($detailedProduct->category_id)->slug) }}">{{ \App\Models\Category::find($detailedProduct->category_id)->getTranslation('name') }}</a>
        </li>
        <li class="text-dark fw-600 breadcrumb-item">
            <a class="text-reset">{{ $detailedProduct->getTranslation('name') }}</a>
        </li>
    </ul>
    <!-- Product Name -->
    ...
    <div class="row align-items-center mb-3">
        ...
        @if ($detailedProduct->auction_product != 1)
            ...
            <div class="col-6">
                ...
                <span class="ml-1 opacity-50 fs-14">{{$detailedProduct->stocks->first()['sku']}}</span>
            </div>
        @endif
    ...
    @if ($detailedProduct->brand != null)
        <div class="d-flex flex-wrap align-items-center mb-3">
            ...
            <a href="{{ url('/brand', $detailedProduct->brand->slug) }}" class="text-reset hov-text-primary fs-14 fw-700">{{ $detailedProduct->brand->name }}</a>
        </div>
    @endif
