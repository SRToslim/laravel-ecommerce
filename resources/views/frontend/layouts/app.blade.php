...
@endif
    ...
    <script>
        ...
        s.parentNode.insertBefore(t,s)}(window, document,'script',
        'https://connect.facebook.net/en_US/fbevents.js');
        fbq('init', '971945076559504');
        fbq('track', 'PageView');
    </script>
    <noscript>
        <img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=971945076559504&ev=PageView&noscript=1"/>
    </noscript>
    <!-- End Meta Pixel Code -->
...
<body>
    ...
    <script src="{{ static_asset('assets/js/customs.js') }}"></script>
