            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th data-breakpoints="lg">{{translate('IP Address')}}</th>
                    ...
                    @foreach($users as $key => $user)
                        @if ($user != null)
                            <tr>
                                ...
                                <td>
                                    @if($user->banned == 1) <i class="fa fa-ban text-danger" aria-hidden="true"></i> @endif {{$user->name}}<br>{{$user->email}}
                                </td>
                                {{-- <td>{{$user->email}}</td> --}}
                                <td>{{$user->phone}}</td>
                                ...
                                <td>
                                    ...
                                    {{ $user->last_login_at != '' ? date('M d, Y h:i a', strtotime($user->last_login_at)) : '' }}
                                </td>
