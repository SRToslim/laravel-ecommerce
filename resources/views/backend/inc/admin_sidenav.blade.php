    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <!-- Website Setup -->
                @canany(['header_setup','footer_setup','view_all_website_pages','website_appearance','contact_page_setup'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endcan
                            @can('contact_page_setup')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('website.contactDetails', ['lang'=>  App::getLocale()] ) }}" class="aiz-side-nav-link {{ areActiveRoutes(['website.contactDetails'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Contact Details')}}</span>
                                    </a>
                                </li>
                            @endcan
                ...
                @canany(['general_settings','features_activation','language_setup','currency_setup','vat_&_tax_setup',
                        ...
                        'google_firebase_setting','shipping_configuration','shipping_country_setting','manage_shipping_states','manage_shipping_cities','manage_zones',
                        'manage_carriers','view_all_outlet','add_outlet','edit_outlet','delete_outlet'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endcan
                            @canany(['view_all_outlet','add_outlet','edit_outlet','delete_outlet'])
                                <li class="aiz-side-nav-item">
                                    <a href="javascript:void(0);" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{translate('Outlets')}}</span>
                                        <span class="aiz-side-nav-arrow"></span>
                                    </a>
                                    <ul class="aiz-side-nav-list level-3">
                                        @can('view_all_outlet')
                                            <li class="aiz-side-nav-item">
                                                <a href="{{ route('outlets.index') }}" class="aiz-side-nav-link">
                                                    <span class="aiz-side-nav-text">{{translate('All Outlets')}}</span>
                                                </a>
                                            </li>
                                        @endcan
                                        @can('add_outlet')
                                            <li class="aiz-side-nav-item">
                                                <a href="{{ route('outlets.create') }}" class="aiz-side-nav-link">
                                                    <span class="aiz-side-nav-text">{{translate('Create Outlet')}}</span>
                                                </a>
                                            </li>
                                        @endcan
                                    </ul>
