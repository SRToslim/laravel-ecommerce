...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::post('/home/section/discount', 'load_to_days_deal_section')->name('home.section.discount');
    ...
    //Outlet
    Route::get('/outlets', 'all_outlets')->name('outlets');
    Route::get('/outlets/{id}', 'outlet_details')->name('outlet.details');
