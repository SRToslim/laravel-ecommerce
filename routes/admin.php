...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::controller(OutletController::class)->group(function(){
        Route::get('/outlets/edit/{id}', 'edit')->name('outlets.edit');
        Route::post('/outlets/update/{id}', 'update')->name('outlets.update');
        Route::get('/outlets/destroy/{id}', 'destroy')->name('outlets.destroy');
    });
    ...
    Route::group(['prefix' => 'website'], function() {
        Route::controller(WebsiteController::class)->group(function () {
            ...
            Route::get('/contact_page', 'contactPage')->name('website.contactDetails');
